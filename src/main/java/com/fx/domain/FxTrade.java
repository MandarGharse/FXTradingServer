...
public class FxTrade {
     ...
     * @param dealtAmount
     */
    public FxTrade(String tradeKey, String tradeVersion, String ccyPair, String buySell, String dealtCcy, String dealtAmount, String counterAmount) {
        super();
    ...
    public String toString() {
        ...
        sb.append(FxTrade.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tradeKey");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FxTrade) == false) {
            return false;
        }
        FxTrade rhs = ((FxTrade) other);
