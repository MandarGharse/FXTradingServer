...
public class BlotterFillRequestMessage {
     ...
     * 
     */
    public BlotterFillRequestMessage() {
    }
     ...
     * @param sessionId
     */
    public BlotterFillRequestMessage(String sessionId, long startIndex, long endIndex) {
        super();
    ...
    public String toString() {
        ...
        sb.append(BlotterFillRequestMessage.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sessionId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BlotterFillRequestMessage) == false) {
            return false;
        }
        BlotterFillRequestMessage rhs = ((BlotterFillRequestMessage) other);
