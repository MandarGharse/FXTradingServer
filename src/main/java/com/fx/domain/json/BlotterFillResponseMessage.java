...
public class BlotterFillResponseMessage {
     ...
     * 
     */
    public BlotterFillResponseMessage() {
    }
     ...
     * @param status
     */
    public BlotterFillResponseMessage(String sessionId, long startIndex, long endIndex, String status, String rejectText, List<FxTrade> trades) {
        super();
    ...
    public String toString() {
        ...
        sb.append(BlotterFillResponseMessage.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sessionId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BlotterFillResponseMessage) == false) {
            return false;
        }
        BlotterFillResponseMessage rhs = ((BlotterFillResponseMessage) other);
