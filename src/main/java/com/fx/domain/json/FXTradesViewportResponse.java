...
public class FXTradesViewportResponse {
     ...
     * 
     */
    public FXTradesViewportResponse() {
    }
     ...
     * @param status
     */
    public FXTradesViewportResponse(String sessionId, long startIndex, long endIndex, String status, String rejectText, List<FxTrade> trades) {
        super();
    ...
    public String toString() {
        ...
        sb.append(FXTradesViewportResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sessionId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FXTradesViewportResponse) == false) {
            return false;
        }
        FXTradesViewportResponse rhs = ((FXTradesViewportResponse) other);
