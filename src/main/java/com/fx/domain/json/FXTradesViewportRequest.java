...
public class FXTradesViewportRequest {
     ...
     * 
     */
    public FXTradesViewportRequest() {
    }
     ...
     * @param sessionId
     */
    public FXTradesViewportRequest(String sessionId, long startIndex, long endIndex) {
        super();
    ...
    public String toString() {
        ...
        sb.append(FXTradesViewportRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sessionId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FXTradesViewportRequest) == false) {
            return false;
        }
        FXTradesViewportRequest rhs = ((FXTradesViewportRequest) other);
