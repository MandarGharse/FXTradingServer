...
public class TradesSubscriptionResponseMessage {
     ...
     * 
     */
    public TradesSubscriptionResponseMessage() {
    }
     ...
     * @param status
     */
    public TradesSubscriptionResponseMessage(String sessionId, String type, String status, String rejectText) {
        super();
    ...
    public String toString() {
        ...
        sb.append(TradesSubscriptionResponseMessage.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sessionId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TradesSubscriptionResponseMessage) == false) {
            return false;
        }
        TradesSubscriptionResponseMessage rhs = ((TradesSubscriptionResponseMessage) other);
